...
function Update()
{
	...
	//If we left click
	if(Input.GetMouseButtonDown(0) || leapTrigger == true)
	//checking on leap trigger
	//if(leapTrigger == true)
	{
...
function UpdateAmountOfReels()
{
	...
	for(var i = 0; i < 5; i++)
	{
		...
		//attempting to add reels to a new layer
		reelInfo[i].reel.layer = 9;
		reelInfo[i].reel.name = "Reel " + i.ToString();
		reelInfo[i].reel.transform.parent = transform;
		//reelInfo[i].reel.transform.localPosition.z = 2;
		//reelInfo[i].reel.transform.localp
